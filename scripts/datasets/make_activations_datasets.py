...
@dataclass
class Args:
    source_dataset: str = "lczero-planning/trajectories"
    source_config: str = "lc0-10-4238.onnx-policy"
    dataset_name: str = "lczero-planning/activations"
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--source_dataset",
        type=str,
        default="lczero-planning/trajectories",
    )
    parser.add_argument(
        "--source_config",
        type=str,
    ...
    parser.add_argument(
        "--dataset_name",
        type=str,
        default="lczero-planning/activations",
    )
